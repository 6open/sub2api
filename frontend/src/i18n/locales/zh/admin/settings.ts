export default {
    settings: {
      ...
      features: {
        ...
        affiliate: {
          title: '邀请返利',
          description: '老用户邀请新用户注册，新用户产生实际用量后老用户按标准用量比例获得返利额度。默认关闭。',
          enabled: '启用邀请返利',
          enabledHint: '关闭后用户菜单中的邀请页面入口隐藏、注册时忽略邀请码、新消费不再产生返利。已有返利额度仍可转入余额。',
          adminRechargeRebate: '管理员充值参与返利',
          adminRechargeRebateHint: '开启后，通过“用户管理 > 充值”增加的余额会产生邀请返利；设置余额和扣款不参与返利。',
          rebateRate: '全局返利比例',
          rebateRateHint: '按被邀请用户标准消费额度返给邀请人的默认比例（0-100%，例如填写 5 表示返利 5%）。',
          freezeHours: '返利冻结期（小时）',
          freezeHoursDesc: '新产生的返利将在冻结期内无法提现。0 = 不冻结。',
          durationDays: '返利有效期（天）',
          durationDaysDesc: '被邀请用户注册后多少天内的消费产生返利。0 = 永久有效。',
      ...
      defaults: {
        ...
        affiliateRebateRateHint: '按被邀请用户标准消费额度返给邀请人的比例（0-100%，例如填写 5 表示返利 5%）',
