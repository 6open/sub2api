export default {
    ...
    users: {
      ...
      creatingApiKey: '创建中',
      apiKeyName: '密钥名称',
      apiKeyNamePlaceholder: '例如 bbs-production',
      selectApiKeyGroup: '请选择分组',
      apiKeyQuota: '密钥额度（USD）',
      apiKeyQuotaHint: '0 表示不单独限制该密钥额度',
      apiKeyExpiry: '有效天数',
      apiKeyExpiryPlaceholder: '留空表示永不过期',
      apiKeyIPWhitelist: 'IP 白名单',
      apiKeyIPWhitelistPlaceholder: '可选，多个 IP 或 CIDR 用逗号或换行分隔',
      showApiKey: '显示完整密钥',
      hideApiKey: '隐藏完整密钥',
      copyApiKey: '复制完整密钥',
      apiKeyCopied: 'API 密钥已复制',
      apiKeyCreated: 'API 密钥创建成功',
      apiKeyCreateFailed: 'API 密钥创建失败',
      group: '分组',
      none: '无',
