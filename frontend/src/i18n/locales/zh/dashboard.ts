export default {
  dashboard: {
    ...
    advancedQuotaResetAvailable: '1 次额度重置机会',
    advancedQuotaResetButton: '重置高级额度',
    advancedQuotaResetTitle: '重置高级额度',
    advancedQuotaResetConfirm: '将消耗唯一一次重置机会，恢复本周完整 $50 高级额度。使用后无法撤销。',
    advancedQuotaResetSuccess: '高级额度已恢复为 $50',
    advancedQuotaResetFailed: '高级额度重置失败',
    apiKeys: 'API 密钥',
    todayRequests: '今日请求',
    todayCost: '今日消费',
