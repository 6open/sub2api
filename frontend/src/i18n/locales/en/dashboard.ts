export default {
  dashboard: {
    ...
    advancedQuotaResetAvailable: '1 quota reset available',
    advancedQuotaResetButton: 'Reset advanced quota',
    advancedQuotaResetTitle: 'Reset advanced quota',
    advancedQuotaResetConfirm: 'This consumes your only reset and restores the full $50 weekly advanced quota. It cannot be undone.',
    advancedQuotaResetSuccess: 'Advanced quota restored to $50',
    advancedQuotaResetFailed: 'Failed to reset advanced quota',
    apiKeys: 'API Keys',
