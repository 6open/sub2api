export default {
    ...
    users: {
      ...
      apiKeyName: 'Key Name',
      apiKeyNamePlaceholder: 'For example, bbs-production',
      selectApiKeyGroup: 'Select a group',
      apiKeyQuota: 'Key Quota (USD)',
      apiKeyQuotaHint: 'Use 0 for no per-key quota limit',
      apiKeyExpiry: 'Validity (days)',
      apiKeyExpiryPlaceholder: 'Leave blank to never expire',
      apiKeyIPWhitelist: 'IP Allowlist',
      apiKeyIPWhitelistPlaceholder: 'Optional; separate IPs or CIDRs with commas or new lines',
      showApiKey: 'Show full key',
      hideApiKey: 'Hide full key',
      copyApiKey: 'Copy full key',
