...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "is_open_webui_default", Type: field.TypeBool, Default: false},
	...
	UserPlatformQuotasColumns = []*schema.Column{
		...
		{Name: "self_service_reset_credits", Type: field.TypeInt, Default: 0},
		{Name: "self_service_reset_granted", Type: field.TypeBool, Default: false},
