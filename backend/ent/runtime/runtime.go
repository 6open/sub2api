...
func init() {
	...
	// apikeyDescIsOpenWebuiDefault is the schema descriptor for is_open_webui_default field.
	apikeyDescIsOpenWebuiDefault := apikeyFields[5].Descriptor()
	// apikey.DefaultIsOpenWebuiDefault holds the default value on creation for the is_open_webui_default field.
	apikey.DefaultIsOpenWebuiDefault = apikeyDescIsOpenWebuiDefault.Default.(bool)
	...
	userDescSignupIP := userFields[13].Descriptor()
