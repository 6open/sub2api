...
func (_u *APIKeyUpdate) SetIsOpenWebuiDefault(v bool) *APIKeyUpdate {
	_u.mutation.SetIsOpenWebuiDefault(v)
	return _u
}

// SetNillableIsOpenWebuiDefault sets the "is_open_webui_default" field if the given value is not nil.
func (_u *APIKeyUpdate) SetNillableIsOpenWebuiDefault(v *bool) *APIKeyUpdate {
	if v != nil {
		_u.SetIsOpenWebuiDefault(*v)
	}
	return _u
}
...
func (_u *APIKeyUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.IsOpenWebuiDefault(); ok {
...
// SetIsOpenWebuiDefault sets the "is_open_webui_default" field.
func (_u *APIKeyUpdateOne) SetIsOpenWebuiDefault(v bool) *APIKeyUpdateOne {
	_u.mutation.SetIsOpenWebuiDefault(v)
	return _u
}

// SetNillableIsOpenWebuiDefault sets the "is_open_webui_default" field if the given value is not nil.
func (_u *APIKeyUpdateOne) SetNillableIsOpenWebuiDefault(v *bool) *APIKeyUpdateOne {
	if v != nil {
		_u.SetIsOpenWebuiDefault(*v)
	}
	return _u
