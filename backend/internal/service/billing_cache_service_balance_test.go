...
func TestCheckBillingEligibility_AllowsAdminWithExhaustedBalance(t *testing.T) {
	...
	err := svc.CheckBillingEligibility(context.Background(), &User{ID: 1, Role: RoleAdmin}, nil, nil, nil, "")
	require.NoError(t, err)
}
