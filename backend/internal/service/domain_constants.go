...
const (
	...
	PlatformOpenAIAdvanced = domain.PlatformOpenAIAdvanced
...
const (
	...
	// SettingKeyOpenAIAdvancedQuotaUsageMultiplier 高级推理额度按模型原价计量时使用的独立倍率。
	SettingKeyOpenAIAdvancedQuotaUsageMultiplier = "openai_advanced_quota_usage_multiplier"
